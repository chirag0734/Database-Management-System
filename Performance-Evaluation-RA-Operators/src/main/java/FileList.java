        ...
        implements List <Comparable []>, RandomAccess
{
     ...
     */
    public FileList (Table _table, String _tableName, int _recordSize)
    {
        table = _table;
    ...
    {
        byte [] record = table.pack (tuple);  // FIX: table.pack (tuple);
    ...
    public Comparable [] get (int i)
    {
        ...
        return table.unpack(record);   // FIX: table.unpack (record);
    } // get
